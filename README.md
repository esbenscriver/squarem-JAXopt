...
# Fixed-point solver
squarem-JAXopt is a implementation of the SQUAREM accelerator for solving fixed-point equations, see [Du and Varadhan (2020)](https://doi.org/10.18637/jss.v092.i07). The implementation is in JAX and builds on [JAXopt](https://github.com/google/jaxopt) for implicit differentiation.
